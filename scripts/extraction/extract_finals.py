# -*- coding: utf-8 -*-
"""Extract the Yau FINALS corpus (2012-2025, F: drive) into ./txt_finals."""
import os, io, re, json
import fitz

BASE = r"sources/finals"
OUT = r".\txt_finals"
...
json.dump(manifest, io.open(r".\data\finals_manifest.json", "w", encoding="utf-8"), ensure_ascii=False, indent=1)
