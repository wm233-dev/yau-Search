...
if __name__ == '__main__':
    for p in [r'sources/finals\2012-2025Geometry and Topology\Overall\2013 Geometry (Overall).docx',
              r'sources/finals\2012-2025Geometry and Topology\Team\2014 Geometry (Team).docx']:
        print('=====', os.path.basename(p))
        for line in docx_text(p):
            print('  |', line)
    p = r'sources/finals\2012-2025Geometry and Topology\Individual\2014 Geometry (Individual&Overall).doc'
