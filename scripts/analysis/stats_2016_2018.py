...
输入: ./scripts/archive/clean_copies/201[678]_*.txt (txt/ 原文件的去 NUL 副本, 文本内容一致)
输出: scripts/archive/dumps/stats_out/stats_2016_2018.txt 与 problems_2016_2018.json
"""
import glob, os, re, json, collections

CLEAN = r'.\scripts\_clean'
OUT   = r'.\scripts\stats_out'
