...
Inputs : ./data/finals_manifest.json  (+ txt_finals/*.txt)
Outputs: ./scripts/finals_app_phys_stats.json
         ./scripts/finals_app_phys_tables.md
"""
...
def main():
    ...
    A("脚本：./scripts/finals_app_phys_stats.py；明细 JSON：finals_app_phys_stats.json。\n")
    A("## 0. 总览\n")
    A("| 指标 | 值 |")
    A("|---|---|")
