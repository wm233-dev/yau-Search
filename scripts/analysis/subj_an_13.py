...
json.dump(probs, open(r".\scripts\an_probs.json","w"), ensure_ascii=False, indent=1)
json.dump({str(k):v for k,v in rows.items()}, open(r".\scripts\an_rows.json","w"), ensure_ascii=False, indent=1)
