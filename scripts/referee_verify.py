...
# -*- coding: utf-8 -*-
r"""
referee_verify.py  —  对 .tmp/burn2026/reports/solutions_analysis.md 中全部可数值检验的
结论做独立复算。运行方式（Windows / PowerShell，工作目录 E:\deepseek_exclusive\math）：

    C:\Python314\python.exe .tmp\burn2026\scripts\referee_verify.py
