...
for p in papers:
    ...
    t=open(os.path.join(r'E:\deepseek_exclusive\math\.tmp\burn2026\txt_finals',[x for x in os.listdir(r'E:\deepseek_exclusive\math\.tmp\burn2026\txt_finals') if True][0]),encoding='utf-8') if False else None
print("---- choose-instruction scan ----")
import io
TXT=r'E:\deepseek_exclusive\math\.tmp\burn2026\txt_finals'
MAN=json.load(open(r'E:\deepseek_exclusive\math\.tmp\burn2026\data\finals_manifest.json',encoding='utf-8'))
cnt=0
for m in MAN:
