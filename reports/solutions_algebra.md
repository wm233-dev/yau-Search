...
- **审稿报告**：`reports/referee_algebra.md`（对抗性审稿，逐题复核题面、结论、证明与全部关键步骤，附可复跑脚本 `scripts/verification/checkA~D.py`）。
...
- **题面复核口径**：题 1–9 已用原卷 PDF（`sources/prelim\`）逐字复核；**题 10（2026 ind №2）本地无原卷**，仅与 `problems_full.json` 抽取文本比对，标点细节可能与原卷有出入。

**数据来源与核对方式**

- 题目全部取自 `data/problems_full.json`（该库共 757 条真题条目，其中 `subject = "Algebra & Number Theory"` 共 149 条，年份 2010–2026）
