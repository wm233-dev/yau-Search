...
> **数据来源**：<code>/data/problems_full.json</code>（全文结构化题库；截至本讲义定稿为 <b>751</b> 条记录，其中 subject 为 "Analysis & PDE" 者 <b>155</b> 道，横跨 2010–2026 共 17 年）。
...
- 题库文件：<code>/data/problems_full.json</code>（截至定稿为 751 条记录；字段：<code>year / subject / paper / kind / n / chars / text</code>）。**注意：本讲义撰写期间该文件被重新生成过一次（早期快照为 757 条、该科目 156 道），本讲义所有引用均已按定稿快照复核。**
